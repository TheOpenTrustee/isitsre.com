        ...
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6">
            ...
            <div className="space-y-6">
              {[1, 2, 3, 4].map((job) => (
                <div key={job} className="p-6 bg-[#0F0F0F] border-l-4 border-[#D97706] rounded-r-lg hover:bg-[#1C1C1C] transition-colors duration-200">
                  <h2 className={`text-xl font-bold mb-2 text-[#E2E8F0] ${spaceGrotesk.className}`}>Senior SRE at TechCorp</h2>
                  <p className="text-sm text-[#A0AEC0] mb-4">
                    TechCorp is seeking an experienced Senior SRE to join our growing team...
                  </p>
                  <Button asChild className="bg-[#D97706] hover:bg-[#B45309] text-white">
                    <Link href={`/job/${job}`}>View Details</Link>
                  </Button>
                </div>
              ))}
            </div>
